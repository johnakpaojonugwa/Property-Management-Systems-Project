...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 mx-3">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-400 rounded-md text-gray-700 focus:ring-1 focus:ring-amber-900 focus:outline-none placeholder:text-gray-300 placeholder:font-medium"
              />
            </div>
          </div>
