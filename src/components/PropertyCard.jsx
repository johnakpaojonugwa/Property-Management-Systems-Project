...
// import Link from "next/link";
// import { IoLocationOutline } from "react-icons/io5";
// import { FaBed, FaShower, FaRulerCombined, FaHeart, FaRegHeart } from "react-icons/fa";
// import { useState } from "react";
// import { useApp } from "@/context/AppContext";
// import { toast } from "react-toastify";
...
//   return (
//     <div className="relative border border-gray-100 bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 text-left hover:-translate-y-2 cursor-pointer">
//       <Link href={`/properties/${id}`}>
//         {/* Image */}
//         <div className="flex justify-start mb-2 items-center rounded-t-xl overflow-hidden relative">
//           <Image
//             src={imageSrc}
//             alt={title}
//             width={400}
...
//             onClick={toggleWishlist}
//             disabled={loading}
//             className="absolute top-3 right-3 bg-white/80 p-2 rounded-full shadow-sm hover:scale-110 transition"
//           >
//             {isWishlisted ? (
//               <FaHeart className="text-red-500" size={18} />
//             ) : (
...
//         {/* Content */}
//         <div className="p-5">
//           <h2 className="text-md mb-3 font-bold text-[#2b2340]">{title}</h2>
...
//           {/* Price */}
//           <p className="text-md leading-relaxed font-bold mb-3 text-[#2b2340]">
//             {price}
//           </p>

//           {/* Details */}
//           <div className="flex gap-4 items-center text-gray-600 text-sm border-t border-gray-200 pt-3">
//             <div className="flex items-center gap-2">
//               <FaBed className="text-[#2b2340]" size={14} />
//               <span className="text-xs">{bedrooms}</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <FaShower className="text-[#2b2340]" size={14} />
//               <span className="text-xs">{bathrooms}</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <FaRulerCombined className="text-[#2b2340]" size={14} />
//               <span className="text-xs">{area}</span>
//             </div>
